...
This file contain the implementation of the plot class: ALLUVIAL

Alluvial is a subclass of the plot class, and as such it inherits all the methods from it.
