...
from ..V1_Categorical import V1_Categorical

class Barplot(V1_Categorical):


    # Default constructor
    def __init__(self, data  = None, categorical_column_index = None,
                 ...
                 fill_color_list = None, border_color_list     = None,                               # Barplot styles parameters
                 fill_alpha_list = None, border_thickness_list = None,              
        ...
        # Barplot related
        self.rotate         = rotate
        self.total_display  = self.data_length
        if(top > 0): self.total_display = min(top, self.data_length)
        self.order          = order

        # Style related (init to default if None is given)
        self.fill_color_list       = fill_color_list
        self.fill_alpha_list       = fill_alpha_list
        self.border_color_list     = border_color_list
        self.border_thickness_list = border_thickness_list
        self.set_style()                                  
    ...
    def automatic_titles(self):
        ...
        self.label_title    = "Barplot for "  + self.data_categorical_name + " in " + self.data_name
    ...
    def automatic_filename(self):
        ...
        string_indexes   = [string_category, string_data]
        ...
        self.filename   = "Barplot_" + join_indexes
    ...
    def set_style(self, fill_color_list = None, border_color_list     = None,                  
                        fill_alpha_list = None, border_thickness_list = None,
                        set_defaults = False):
 
        # If the user gave a list of colors
        if(fill_color_list != None):
            
            # If the user gave a list of colors
            if(type(fill_color_list) == list):
                
                # Check that the list is the same length as the data
                if(len(fill_color_list) != self.data_length):
                    print()
                    print("WARNING!: The color list you gave me is not the same length as the data.")
                    print("          I will use the default colors instead.")
                    print()
                    
                    default_color        = color_manager.get_qualitative_colors(1)
                    self.fill_color_list = [default_color] * self.data_length
            ...
            # (This would be quite ugly though, as all the lines will have the same color; WEIRD!)
                ...
                self.fill_color_list = [fill_color_list] * self.data_length            

        # Otherwise, init to default
        else:
            if(set_defaults or self.fill_color_list == None):
                default_color        = color_manager.get_qualitative_colors(1)
                self.fill_color_list = [default_color] * self.data_length
        

        # If the user gave a list of border colors
        if(border_color_list != None):
            
            # If the user gave a list of colors
            if(type(border_color_list) == list):
                
                # Check that the list is the same length as the data
                if(len(border_color_list) != self.data_length):
                    print()
            ...
            # We will use the same color for all the data
                ...
                self.border_color_list = [border_color_list] * self.data_length

        # Otherwise, init to default
        else:
            if(set_defaults or self.border_color_list == None):
                default_color          = "black"
                self.border_color_list = [default_color] * self.data_length


        # If the user gave a list of fill alphas
        if(fill_alpha_list != None):
            
            # If the user gave a list of colors
            if(type(fill_alpha_list) == list):
                
                # Check that the list is the same length as the data
                if(len(fill_alpha_list) != self.data_length):
                    print()
                    ...
                    default_alpha        = 0.9
                    self.fill_alpha_list = [default_alpha] * self.data_length
            ...
            # We will use the same color for all the data
                ...
                self.fill_alpha_list = [fill_alpha_list] * self.data_length   
        ...
        if(border_thickness_list != None):
                
            # If the user gave a list of colors
            if(type(border_thickness_list) == list):
                
                # Check that the list is the same length as the data
                if(len(border_thickness_list) != self.data_length):
                    print()
                    ...
                    default_thickness          = 1
                    self.border_thickness_list = [default_thickness] * self.data_length
            ...
            # We will use the same color for all the data
                ...
                self.border_thickness_list = [border_thickness_list] * self.data_length
