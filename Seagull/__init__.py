...
class Seagull:
    ...
    from .methods.setters_and_getters import getPanda, ncol, nrow, getTotalColumns, getTotalRows
    ...
    from .methods.data_manipulation import renameColumns, renameColumn, columnToInteger, columnToFloat, setColumnZeroes, setColumnZeroesF
